...
namespace ThaniWebApi
{
    public class ClsGlobal
    {
        ...
        public static String SqlCatalog = "ubritene_WebAsync"; //"WebAsync";
        //public static String SqlSource2 = "LAPTOPHP\\SQLEXP2017"; //office\\sql2017"; // "(LOCALDB)\\MSSQLLOCALDB";
        public static String SqlSource2 = "162.249.5.100"; //"OFFICE\\SQL2017"; //office\\sql2017"; // "(LOCALDB)\\MSSQLLOCALDB";
